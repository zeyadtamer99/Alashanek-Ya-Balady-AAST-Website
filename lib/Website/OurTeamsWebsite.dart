...
import '../Widgets/Teams/TeamCardLeft.dart';
import '../Widgets/Teams/TeamCardRight.dart';

class OurTeamsWebsite extends StatefulWidget {
  const OurTeamsWebsite({Key? key}) : super(key: key);

  @override
  State<OurTeamsWebsite> createState() => _OurTeamsWebsiteState();
}

class _OurTeamsWebsiteState extends State<OurTeamsWebsite> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(child: Column(
        children: [
          ...
          TeamCardLeft(title: 'Charity', description: charityDesc, screenWidth: screenWidth, screenHeight: screenHeight, teamImage: 'assets/images/charity.jpg',),
          Container(
          ...
          TeamCardRight(title: 'Research & Development', description: rdDesc, screenWidth: screenWidth, screenHeight: screenHeight, teamImage: 'assets/images/R&D.jpg',),
          Container(
            margin: EdgeInsets.symmetric(vertical: screenHeight*0.1),
            width: screenWidth*0.8,
            child: Divider(
          ...
          TeamCardLeft(title: 'Youth Development Program', description: ydpDesc, screenWidth: screenWidth, screenHeight: screenHeight, teamImage: 'assets/images/YDP.jpg',),
          Container(
            margin: EdgeInsets.symmetric(vertical: screenHeight*0.1),
            width: screenWidth*0.8,
            child: Divider(
          ...
          TeamCardRight(title: 'Public Relation', description: prDesc, screenWidth: screenWidth, screenHeight: screenHeight, teamImage: 'assets/images/PR.png',),
          Container(
            margin: EdgeInsets.symmetric(vertical: screenHeight*0.1),
            width: screenWidth*0.8,
            child: Divider(
          ...
          TeamCardLeft(title: 'Human Resources', description: hrDesc, screenWidth: screenWidth, screenHeight: screenHeight, teamImage: 'assets/images/hr.png',),
          Container(
            margin: EdgeInsets.symmetric(vertical: screenHeight*0.1),
            width: screenWidth*0.8,
            child: Divider(
          ...
          TeamCardRight(title: 'Marketing & Media', description: marketDesc, screenWidth: screenWidth, screenHeight: screenHeight, teamImage: 'assets/images/MM.jpg',),
