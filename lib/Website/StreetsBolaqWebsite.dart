...
class StreetsBolaqWebsite extends StatefulWidget {
  const StreetsBolaqWebsite({Key? key}) : super(key: key);

  @override
  State<StreetsBolaqWebsite> createState() => _StreetsBolaqWebsiteState();
}

class _StreetsBolaqWebsiteState extends State<StreetsBolaqWebsite> {
  @override
