...
import 'PeopleBolaqWebsite.dart';

class EditPeopleWebsite extends StatefulWidget {
  String street;
  String docId;
  String name;
  String sex;
  ...
  @override
  State<EditPeopleWebsite> createState() => _EditPeopleWebsiteState();
}

class _EditPeopleWebsiteState extends State<EditPeopleWebsite> {
