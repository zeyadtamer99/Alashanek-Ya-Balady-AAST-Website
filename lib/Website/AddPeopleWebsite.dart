...
import 'package:ayb_database/Classes/Street.dart';
...
class AddPeopleWebsite extends StatefulWidget {
  double screenWidth;
  double screenHeight;
  String street;
  AddPeopleWebsite(
      {super.key, required this.street,
        required this.screenWidth,
        required this.screenHeight});

  @override
  _AddPeopleWebsiteState createState() => _AddPeopleWebsiteState();
}

class _AddPeopleWebsiteState extends State<AddPeopleWebsite> {
  ...
  List<String> list = <String>[
    ...
    'Widow',
    'Divorced',
    'its Complicated','None'
  ];
  String dropdownValue = 'None';

  List<String> workList = <String>['Monthly', 'Weekly', 'Daily', '3ala allah','None'];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: widget.screenWidth * 0.125,
                                        child: TextField(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      var docId=nameContoller.text + "-" + random.nextInt(100).toString();
                      Map<String, dynamic> newPeople = {
                        'id':docId,
                        'name': nameContoller.text.isEmpty ? "None" : nameContoller.text,
                        'sex': sexIndex == 0 ? "Male" : "Female",
                        'numOfPeople':int.tryParse(numOfPeopleContoller.text) ?? 0,
                        'socialStatus': dropdownValue,
                        'age': int.tryParse(ageContoller.text) ?? 0,
                        'buildingNum':int.tryParse(buildingNumContoller.text) ?? 0,
                        'phoneNum': int.tryParse(phoneNumContoller.text)??0,
                        'debtPaid':int.tryParse(debtPaidController.text)?? 0 ,
                        'debtAmount': int.tryParse(debtAmountController.text)?? 0,
                        'debtType': dropdowndebtTypeValue,
                        'maxDebtDate': debtDueDateController.text.isEmpty?"None":debtDueDateController.text,
                        'medicine':_arrayListMedicine.isEmpty ? ["None"] : _arrayListMedicine,
                        'operations':_arrayListOperation.isEmpty ? ["None"] : _arrayListOperation,
                        'disease':_arrayListDisease.isEmpty ? ["None"] : _arrayListDisease,
                        'jobType':dropdownWorkValue,
                        'kindOfJob':jobController.text.isEmpty?"None":jobController.text,
                        'totalMasareef':int.tryParse(totalMasareefController.text)??0,
                        'salary':int.tryParse(incomeAmountController.text)??0,
                ...
                BottomPart(screenHeight: widget.screenHeight,),
              ],
            ),
          ),
        ),
